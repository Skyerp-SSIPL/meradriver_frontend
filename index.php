            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="single-banner">
                     <img src="img/pages/Group 1.png" alt="help">
                  </div>
               </div>
            </div>
         </div>
                              ...
                              <div class="premium-collection swiper-wrapper"
                                 ...
                                 <div class="swiper-slide tupple" style="width: 233.123px; margin-right: 16px;">
                                    <span class="industry-card"
                                       ...
                                       <div class="chip-heading-div">
                                          ...
                                          <img class="ntc__chip-arrow" src="img/pages/arrow.2b55815e.svg"
                                             alt="arrow-icon">
                                       </div>
                                       <div class="industry_widget_logos">
                                          <div class="chip-image"><img src="img/pages/ola8.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                          <div class="chip-image"><img src="img/pages/ola9.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                          <div class="chip-image"><img src="img/pages/loa10.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                 ...
                                 <div class="swiper-slide tupple" style="width: 233.123px; margin-right: 16px;">
                                    <span class="industry-card"
                                       ...
                                       <div class="industry_widget_logos">
                                          <div class="chip-image"><img src="img/pages/ola4.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                          <div class="chip-image"><img src="img/pages/ola2.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                          <div class="chip-image"><img src="img/pages/ola8.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                          <div class="chip-image">
                                            <img src="img/pages/ola.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                       </div>
                                    </span>
                                 </div>
                                 ...
                                 <div class="swiper-slide tupple" style="width: 233.123px; margin-right: 16px;">
                                    <span class="industry-card"
                                       ...
                                       <div class="industry_widget_logos">
                                          <div class="chip-image"><img src="img/pages/ola4.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                          <div class="chip-image"><img src="img/pages/ola7.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                          <div class="chip-image"><img src="img/pages/ola8.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                          <div class="chip-image">
                                 ...
                                 <div class="swiper-slide tupple" style="width: 233.123px; margin-right: 16px;">
                                    <span class="industry-card"
                                       ...
                                       <div class="industry_widget_logos">
                                          <div class="chip-image"><img src="img/pages/ola9.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                          <div class="chip-image"><img src="img/pages/ola10.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                          <div class="chip-image"><img src="img/pages/ola11.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                          <div class="chip-image">
                                            <img src="img/pages/ola1.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                       </div>
                                    </span>
                                 </div>
                                 ...
                                 <div class="swiper-slide tupple swiper-slide-active"
                                    ...
                                    <span class="industry-card"
                                       ...
                                       <span class="industry-company">50+ drivers required for delivery </span>
                                          <div class="industry_widget_logos">
                                          <div class="chip-image"><img src="img/pages/ola3.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                          <div class="chip-image"><img src="img/pages/ola2.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                          <div class="chip-image"><img src="img/pages/ola1.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                                          <div class="chip-image">
                                            <img src="img/pages/ola.gif"
                                                class="companyLogo" alt="" height="" width=""></div>
                     ...
                     <div class="role-collection-wdgt">
                        <div class="card-container">
                           <div class="left-section">
                              <img src="img/pages/role-collection-ot.png" class="role-img"
                                          ...
                                          <div class="chip-case">
                                             <div class="chip">
                                                <div class="chip-text">
                                                   ...
                                                   <p class="chip-count">1.2K+ Jobs  <img class="ntc__chip-arrow" src="img/pages/arrow.2b55815e.svg"
                                                   alt="arrow-icon"></p>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="chip-case">
                                             <div class="chip">
                                                <div class="chip-text">
                                                   ...
                                                   <p class="chip-count">800+ Jobs  <img class="ntc__chip-arrow" src="img/pages/arrow.2b55815e.svg"
                                                   alt="arrow-icon"></p>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="chip-case">
                                             <div class="chip">
                                                <div class="chip-text">
                                                   ...
                                                   <p class="chip-count">600+ Jobs  <img class="ntc__chip-arrow" src="img/pages/arrow.2b55815e.svg"
                                                   alt="arrow-icon"></p>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="chip-case">
                                             <div class="chip">
                                                <div class="chip-text">
                                                   ...
                                                   <p class="chip-count">2.3K+ Jobs  <img class="ntc__chip-arrow" src="img/pages/arrow.2b55815e.svg"
                                                   alt="arrow-icon"></p>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="chip-case">
                                             <div class="chip">
                                                <div class="chip-text">
                                                   ...
                                                   <p class="chip-count">1K+ Jobs  <img class="ntc__chip-arrow" src="img/pages/arrow.2b55815e.svg"
                                                   alt="arrow-icon"></p>
                                                </div>
                                             </div>
                                          </div>
                  ...
                  <div id="naukri-events-homepage-wdgt">
                     <div class="naukri-swiper-wdgt naukri-events-swiper">
                        <div class="logo-container">
                           ...
                           <img src="img/pages/Isolation_Mode.png" class="logo"
                                    ...
                                    <div class="feature-card-container desktop-homepage-events-wdgt">
                                       <div class="feature-card-header-image-container">
                                          <div class="feature-card-image-container">
                                             <img src="img/pages/man-car-driving.jpg"
...
<p class="feature-card-type-label">
                                 ...
                                 <div class="swiper-slide tupple swiper-slide-next"
                                    ...
                                    <div class="feature-card-container desktop-homepage-events-wdgt">
                                       <div class="feature-card-header-image-container">
                                          <div class="feature-card-image-container">
                                             <img src="img/pages/man-car-driving (1).jpg"
                                                class="feature-card-image" alt="feature-card" height="" width=""
                                                iserrored="true">
                                             <div class="feature-card-image-overlay"></div>
                                             <div class="feature-card-date-rewards-container">
